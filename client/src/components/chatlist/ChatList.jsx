        ...
        <div className='w-1/5 bg-gray-50 p-4 flex flex-col gap-3 shadow-inner'>
            ...
            {chatSessions.map((session, index) => (
                <div
                    ...
                    className={classNames('flex items-center px-4 py-3 rounded-md transition-all cursor-pointer shadow', currentSession?.session_id == session.session_id ? 'bg-gray-700 !text-white hover:bg-gray-600' : 'bg-white hover:bg-blue-100 text-gray-700')}
                >
            ...
            {isNewChat
                ? <div
                    className='flex items-center px-4 py-3 rounded-md bg-white hover:bg-blue-100 transition-all cursor-pointer shadow'
                >
                    <IoIosChatbubbles className='text-gray-700 mr-2' />
